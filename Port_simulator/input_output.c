...
int display_instructions (const char * archivo_letra_titulo, const char * archivo_letra_cuerpo, const char * color_letra)
{
    ...
    messages[FLASH] = "- La tecla 'b' hace que los leds parpadeen en su estado actual";
    messages[CHARGE] = "- La tecla 's' prende todos los leds";
    messages[DISCHARGE] = "- la tecla 'c' apaga todos los leds";
