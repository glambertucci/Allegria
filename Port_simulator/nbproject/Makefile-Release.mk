...
${OBJECTDIR}/get_char.o: get_char.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/get_char.o get_char.c

${OBJECTDIR}/get_mask.o: get_mask.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/get_mask.o get_mask.c
...
${OBJECTDIR}/print_status.o: print_status.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/print_status.o print_status.c

${OBJECTDIR}/string_to_mask.o: string_to_mask.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_to_mask.o string_to_mask.c

${OBJECTDIR}/tp_grupo4.o: tp_grupo4.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tp_grupo4.o tp_grupo4.c

${OBJECTDIR}/validation.o: validation.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/validation.o validation.c
